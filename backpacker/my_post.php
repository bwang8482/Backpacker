...
<?php
    ...
    $sql = "SELECT * FROM post WHERE writer_username='$cur_user' ORDER BY date DESC ";
                ...
                <div class="box">
                    <div class="col-lg-12">
                        ...
                        <div style="margin-left:900px; margin-right: auto">
                            <form method="post" action="update.php" style="float:left" >
                                <input type="submit" class="btn btn-primary btn-m " style="width:80px"name="update" value="Update"/>
                                <input type="hidden"  class="btn btn-primary btn-m " style="width:80px" name="post_id" value=" '.$row['post_id'].' "/>
                            </form>
