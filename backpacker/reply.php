<?php session_start(); 
    ...
    $su_replayTo=$_POST['replyToUser'];
    // $conn = new mysqli($servername, $username, $password, $dbname);
    // $query = "SELECT * FROM message WHERE post_id='$su_post_id'";
    ...
    <div style="margin-left:auto; margin-right:auto;position:relative;">
        ...
        <div style="width:100%; margin-left:auto; margin-right:auto;">
            <div class="container" style="margin-left:auto; margin-right:auto;">
              <h1 style ="margin-top:150px; width:60%; margin-left:auto; margin-right:auto; color:white" class="text-center">Reply Message</h1>
              ...
              <form role="form" action="" method="POST" name="message_form" onsubmit="return validateForm()">
                <div class="form-group">
                  ...
                  <textarea name="sendToUser" class="form-control" rows="1" id="comment" style="width:60%; margin-left:auto; margin-right:auto; margin-bottom:10px"><?php echo $su_replayTo;?></textarea>
                  ...
                  <textarea name="messageContext" class="form-control" rows="20" id="comment" placeholder="Share your incredible idea with others!" style="width:60%; margin-left:auto; margin-right:auto; margin-bottom:10px"></textarea>
                   ...
                   <input type="submit" name="submit" class="btn btn-primary btn-m active" style="width:15%;"value="Reply">
                   </div>
                </div>
